...
namespace SkirmishWars.UnityRenderers
{
    ...
    public sealed class CursorRenderer : MonoBehaviour
    {
        ...
        private void OnTeamChanged(Team team)
        {
            ...
            cursorSprite.color = team.style.baseColor;
            highlightSprite.color = team.style.baseColor;
            cursorSprite.flipX = team.style.flipX;
        }
